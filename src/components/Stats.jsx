...
export default function Home() {
    return (
        <>
            <div className="xl:px-20 px-6 py-20 xl:mx-auto  bg-gray-100 ">
                <h1 className="xl:text-5xl md:text-4xl text-2xl font-semibold leading-tight text-center text-gray-800 sm:mb-0 mb-12">
                    Mais de 20 Anos de Experiencia <br className="md:block hidden" />
                    em Produtos Essenciais para seu empreendimento
                </h1>
