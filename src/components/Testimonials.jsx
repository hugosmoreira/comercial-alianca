...
export default function Testimonials() {
    return (
        <>
            <div>
                <h2 className="text-2xl leading-6 text-gray-800 text-center px-4">Testimoniais</h2>
                <h1 className="lg:text-5xl md:text-4xl text-2xl font-semibold px-4 leading-10 text-gray-800 mt-6 text-center">O que nossos clients dizem</h1>
